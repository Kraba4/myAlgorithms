...
int main()
{
    int n, i, request, task;
    std::cin >> n;
    std::string name;
    std::map<std::string, TreeAVL<int>> company;
    for (i = 0; i < n; i++)
    {
        std::cin >> request;
        switch (request)
        {
            ...
            case 3:
            {
                ...
                {
                    company[name].insert(task);
                    std::cout << company[name].size() << " ";
                }
                break;
            }
            case 4:
            {
                ...
                if (company.count(name) == 0)
                    std::cout << -1 << " ";
                else if (!company[name].contains(task))
                    std::cout << -2 << " ";
                else
                {
                    company[name].erase(task);
                    std::cout << company[name].size() << " ";
                }
                break;
            }
